...
This sounds a bit daunting at first but can 
...
![](Lists_from_Wickham.png)

Screenshot from Hadley Wickham's best book: [Advanced R](https://adv-r.hadley.nz/index.html).
